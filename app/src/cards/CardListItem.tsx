...
export function CardListItem({ card, dragHandle }: CardListItemProps) {
  return (
    <div className="flex items-center gap-1 rounded-2xl border border-slate-200 bg-white pr-3.5 shadow-sm transition hover:border-slate-300">
      {dragHandle && (
        <button
          type="button"
          {...dragHandle}
